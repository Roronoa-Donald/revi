/* ============================================
   RD WINSERVER — Course Downloader
   ============================================ */
...
class CourseDownloader {
    ...
    download(format) {
        ...
        const title = document.querySelector('h1')?.textContent || 'RD WinServer';
    ...
    downloadPDF(title, content) {
        ...
        win.document.write(`<!DOCTYPE html><html><head><title>${title}</title>
            ...
            h1{color:#4b5563;border-bottom:2px solid #6b7280;padding-bottom:0.5rem;}
