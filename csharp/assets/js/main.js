...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ThemeManager = {
        init() {
            ...
            const saved = localStorage.getItem('rd_csharp_theme');
            if (saved) {
        ...
        switch() {
            ...
            localStorage.setItem('rd_csharp_theme', next);
    ...
    (function() {
        ...
        const check = () => {
            ...
            if (pct > 0.85) {
                ...
                const arr = JSON.parse(localStorage.getItem('rd_csharp_completed') || '[]');
                if (!arr.includes(num)) {
                    arr.push(num);
                    localStorage.setItem('rd_csharp_completed', JSON.stringify(arr));
