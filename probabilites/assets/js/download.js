/* ============================================
   Probabilités — Course Downloader
   ============================================ */
...
class CourseDownloader {
    ...
    download(format) {
        ...
        const title = document.querySelector('h1')?.textContent || 'Probabilités';
        ...
        switch (format) {
            ...
            case 'txt':
                ...
                break;
            case 'formules':
                window.location.href = 'chapitres/formules.html';
                break;
            case 'exercices':
                window.location.href = 'exercices/exercices.html';
                break;
            default:
                this.downloadTXT(title, content);
        }
    ...
    extractText(el) {
        ...
        clone.querySelectorAll('script, style, .exercise-tabs, button, .quiz-options, .MathJax').forEach(e => e.remove());
